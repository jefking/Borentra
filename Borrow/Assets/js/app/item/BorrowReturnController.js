(function ($) {
  var context = $("#dialogBorrowReturn");
  ...
  $(".btn-borrow-returned").on("click", function (event) {
  ...
  var execute = function (params) {
    ServiceLocator.getService("addBorrowReturn").invoke(params, function (err, response) {
      context.modal("hide");
