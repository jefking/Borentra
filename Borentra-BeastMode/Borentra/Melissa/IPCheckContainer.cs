...
namespace MelissaData {
    ...
    public partial class IPCheckEntity {
        ...
        {
            var city = this.City == "NULL" ? null : this.City;
            var region = this.Region == "NULL" ? null : this.Region;
            var country = this.Country == "NULL" ? null : this.Country;
            return string.Format("{0}, {1}, {2}", city ?? string.Empty, region ?? string.Empty, country ?? string.Empty);
        }
    }
